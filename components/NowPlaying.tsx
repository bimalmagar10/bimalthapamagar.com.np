import { HStack, Text, Box, chakra, Link, Flex } from "@chakra-ui/react";
  ...
  return (
    <Box overflow="hidden" height="20px">
      ...
      <ChakraBox
        ...
        bg="#1ed05e"
        initial={{ y: "0px" }}
        animate={{ y: ["0px", "21px", "0px"], scaleY: [1.0, 0.5, 1.0] }}
...
const NowPlaying = () => {
  ...
  return (
    <Flex
      p="1rem 0"
      gap={["0rem", "1rem", "1rem", "1rem"]}
      flexDirection={["column", "row", "row", "row"]}
      alignItems={["flex-start", "center", "center", "center"]}
      mb={["3rem", "0rem", "0rem", "0rem"]}
    >
