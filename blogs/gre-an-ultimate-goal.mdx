...
**Note:**&nbsp;Consequently,regarding the positions, one can apply for Teaching Assistant and Research Assistant.May be there are other positions as well,but as far as I know these are the commonplace.Also, there are many other universities,high ranked and low ranked, other than the above mentioned ones that accepts minimal to maximal GRE scores.
